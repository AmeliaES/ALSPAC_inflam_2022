# Associations between PRSs and PEs
...
dataTrans <- data %>%
  ...
  mutate_at(c("BMI_age7", "BMI_age9",  
              "CRP_SBayesR", "IL6_SBayesR", paste0("pc", 1:10)), scale)
# ----------------------------------------------------------------------------
...
# ----------------------------------------------------------------------------
# Test for associations between PEs and PRSs for CRP and IL-6
##############################################################################
...
# CRP 
# SBayesR
CRP_nb_nocovars_SBayesR <- glm.nb(PLE_total ~ CRP_SBayesR + Sex + pc1 + pc2 + pc3 + pc4 + pc5 + pc6 + pc7 + pc8 + pc9 + pc10,  data = dataTrans)

# IL-6
# SBayesR
IL6_nb_nocovars_SBayesR <- glm.nb(PLE_total ~ IL6_SBayesR + Sex + pc1 + pc2 + pc3 + pc4 + pc5 + pc6 + pc7 + pc8 + pc9 + pc10,  data = dataTrans)

# Fully Adjusted
# CRP 
# SBayesR
CRP_nb_SBayesR <- glm.nb(PLE_total ~ CRP_SBayesR + Sex + pc1 + pc2 + pc3 + pc4 + pc5 + pc6 + pc7 + pc8 + pc9 + pc10 + Maternal.education.at.birth,  data = dataTrans)

# IL-6
# SBayesR
IL6_nb_SBayesR <- glm.nb(PLE_total ~ IL6_SBayesR + Sex + pc1 + pc2 + pc3 + pc4 + pc5 + pc6 + pc7 + pc8 + pc9 + pc10 + Maternal.education.at.birth,  data = dataTrans)
# ----------------------------------------------------------------------------
...
results
write.csv(results, "Regression_analysis/Output/PRS_PLE_base.csv",row.names = F)
...
results
write.csv(results,  "Regression_analysis/Output/PRS_PLE_fully_adjusted.csv", row.names = F)
...
# CRP 
# SBayesR
CRP_nb_male_nocovars_SBayesR <- glm.nb(PLE_total ~ CRP_SBayesR + pc1 + pc2 + pc3 + pc4 + pc5 + pc6 + pc7 + pc8 + pc9 + pc10,  data = dataTransMale)

# IL-6
# SBayesR
IL6_nb_male_nocovars_SBayesR <- glm.nb(PLE_total ~ IL6_SBayesR + pc1 + pc2 + pc3 + pc4 + pc5 + pc6 + pc7 + pc8 + pc9 + pc10,  data = dataTransMale)

# Fully Adjusted
# CRP 
# SBayesR
CRP_nb_male_SBayesR <- glm.nb(PLE_total ~ CRP_SBayesR  + pc1 + pc2 + pc3 + pc4 + pc5 + pc6 + pc7 + pc8 + pc9 + pc10 + Maternal.education.at.birth,  data = dataTransMale)

# IL-6
# SBayesR
IL6_nb_male_SBayesR <- glm.nb(PLE_total ~ IL6_SBayesR  + pc1 + pc2 + pc3 + pc4 + pc5 + pc6 + pc7 + pc8 + pc9 + pc10 + Maternal.education.at.birth,  data = dataTransMale)
...
# CRP 
# SBayesR
CRP_nb_female_nocovars_SBayesR <- glm.nb(PLE_total ~ CRP_SBayesR + pc1 + pc2 + pc3 + pc4 + pc5 + pc6 + pc7 + pc8 + pc9 + pc10,  data = dataTransFemale)

# IL-6
# SBayesR
IL6_nb_female_nocovars_SBayesR <- glm.nb(PLE_total ~ IL6_SBayesR + pc1 + pc2 + pc3 + pc4 + pc5 + pc6 + pc7 + pc8 + pc9 + pc10,  data = dataTransFemale)

# Fully Adjusted
# CRP 
# SBayesR
CRP_nb_female_SBayesR <- glm.nb(PLE_total ~ CRP_SBayesR + pc1 + pc2 + pc3 + pc4 + pc5 + pc6 + pc7 + pc8 + pc9 + pc10 + Maternal.education.at.birth,  data = dataTransFemale)

# IL-6
# SBayesR
IL6_nb_female_SBayesR <- glm.nb(PLE_total ~ IL6_SBayesR + pc1 + pc2 + pc3 + pc4 + pc5 + pc6 + pc7 + pc8 + pc9 + pc10 + Maternal.education.at.birth,  data = dataTransFemale)
...
results_sex
write.csv(results_sex, "Regression_analysis/Output/PRS_PLE_sex_split_base.csv",          row.names = F)

results_sex <- do.call( rbind, 
                        list(
                             result_func_sex(CRP_nb_male_SBayesR, "Fully Adjusted", "CRP PRS (SBayesR)", "MALE", dataTransMale),
...
results_sex
write.csv(results_sex,  "Regression_analysis/Output/PRS_PLE_sex_split_fully_adjusted.csv",          row.names = F)
