# Remove person with very high IL-6 as a sensitivity analysis
...
results
write.csv(results, "Regression_analysis/Output/IL6_rm_sensitivity.csv", quote = F, row.names = F)

lapply(c("Regression_analysis/Output/blood_dep_base.csv",
         "Regression_analysis/Output/blood_dep_fully_adjusted.csv",
         "Regression_analysis/Output/blood_PLE_base.csv",
         "Regression_analysis/Output/blood_PLE_fully_adjusted.csv"), read.csv) %>% do.call(rbind,.)
